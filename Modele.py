...
### TP 06 #####################################################################
    def calculercouleur(self,M3D,scene): #modele d illumination au point M3D
                 
        N=vecteur3.Vecteur(self.facette.normale[0][0],self.facette.normale[0][1],self.facette.normale[0][2])
        V=vecteur3.Vecteur(-M3D[0],-M3D[1],-M3D[2]) # camera en O
        V=V.normer()
        R=2*(N*V)*N-V   #les vecteurs sont normes
        
        
        coulR=scene.Ia*self.facette.coefs[0]*self.facette.couleur[0]
        coulG=scene.Ia*self.facette.coefs[0]*self.facette.couleur[1]
        coulB=scene.Ia*self.facette.coefs[0]*self.facette.couleur[2]
        ...
        for lum in scene.listelum :
            ...
            if costheta>0 : #diffus
                ...
                coulR+=val*self.facette.couleur[0]
                coulG+=val*self.facette.couleur[1]
                coulB+=val*self.facette.couleur[2]
