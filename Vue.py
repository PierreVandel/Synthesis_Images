...
class VueCourbes(object):
    ...
    def callbackdiagonalePGD(self):
        """ Initialise l'outils courant pour ajouter une nouvelle diagonale. """
        self.outilsCourant = self.controleur.nouvelleDiagonalPGD()
        self.outilsSauvergarde = lambda : self.callbackdiagonalePGD()
        self.requieredAddedControles = 2
        
    def callbackdiagonalePointMilieu(self):
        """ Initialise l'outils courant pour ajouter une nouvelle diagonale. """
        self.outilsCourant = self.controleur.nouvelleDiagonalPointMilieu(self.segmentColor)
        self.outilsSauvergarde = lambda : self.callbackdiagonalePointMilieu()
        self.requieredAddedControles = 2
    ...
    def executer(self):
        ...
        toolsmenu.add_command(label="Ajouter une diagonale avec PGD", command=self.callbackdiagonalePGD)
        toolsmenu.add_command(label="Ajouter une diagonale avec point milieu", command=self.callbackdiagonalePointMilieu)
        ### Ajouts TPs ###
        ## Boutons ##
